...
<aside id="default-sidebar" class="fixed mb-10 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 px-6 py-8" aria-label="Sidebar">
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex items-center">
                                                        <div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div>  {{$post->created_at->diffForHumans()}}
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 inline-flex">
                                                    <!-- dd({{$post}}) -->
                                                    <a href="/admin/posts/{{$post->id}}/edit" class="mr-2"> 
                                                    ...
                                                    <form method="POST" action="/admin/posts/destroy/{{$post->id}}">
                                                    @csrf
                                                    @method('DELETE')
