...
<div class="flex ">
    <aside id="default-sidebar" class=" overflow-x-auto shadow-lg sm:rounded-lg" aria-label="Sidebar">
                    ...
                    @foreach($users as $user)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full" src="/storage/{{$user->thumbnail}}" alt="Jese image">
                                ...
                                <td class="px-6 py-4 inline-flex">
                                    ...
                                    <!-- <a href="/admin/users/{{$user->id}}/edit" class="mr-2"> 
